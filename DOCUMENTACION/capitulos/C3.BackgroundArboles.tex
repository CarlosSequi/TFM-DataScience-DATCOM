...
Describimos en este apartado una métrica para que tenga en cuenta tanto el error como las restricciónes monotónicas a la hora de decidir si expandir un nodo del árbol de decisión, lo que lo convierte en el segundo de los métodos que describiremos para la creación de árboles de decisión montónicos.
